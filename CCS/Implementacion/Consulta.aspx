<%@ Page  Title="" Language="vb"  MasterPageFile="~/Masterpages/Content.Master" AutoEventWireup="false" CodeBehind="Consulta.aspx.vb" Inherits="CCS.Consulta" %>
                        ...
                        <asp:Panel ID="Panel6" runat="server" CssClass="Panel">
                            ...
                            <div class="TablaCentro" style="margin-top: -30px;">
                                ...
                                <asp:Panel ID="panel900" runat="server" Width="700px" CssClass="margencitofull">
                                   ...
                                   <asp:Label ID="Label246" runat="server" Text="Selecciona Campaña:" BackColor="#CC0000" Font-Bold="True" Font-Size="11pt" ForeColor="White" Width="200px"></asp:Label>
                                                            
                                     <asp:DropDownList ID="DropDownList109" runat="server" Width="271px" Height="37px" AutoPostBack="True" >
                                     </asp:DropDownList>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <tr>
                                                             ...
                                                             <td class="auto-style24">
                                                                ...
                                                                <ContentTemplate>
                                                                    <asp:FileUpload ID="fuimage31" runat="server" BorderColor="#999966" />
                                                                    ...
                                                                    <td>
                                                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <asp:Button ID="btSubir050" runat="server" ForeColor="#000066" OnClick="btSubir_Click050" Text="Subir Imagen" style="height: 26px" />
                                                                                <asp:Label ID="Label172" runat="server" ForeColor="Red"></asp:Label>
                                                                            </ContentTemplate>
                                                                            <Triggers>
                                                                                <asp:PostBackTrigger ControlID="btSubir050" />
                                                                            </Triggers>
                                                                        </asp:UpdatePanel>
                                                                    </td>
                                                                </tr>
